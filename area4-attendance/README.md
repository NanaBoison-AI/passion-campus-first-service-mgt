...
| Location (lat,lng) | LOCATION, GPS, COORDINATES, GEO *(added automatically when first used)* |
| Google Maps link | MAP_LINK, GOOGLE MAPS, MAPS LINK, MAP *(added automatically when first used)* |
| Gender | GENDER, SEX |
| Status | STATUS |
